...
# Combined Makefile for C++ projects with OpenGL support
...
ifneq ($(DEP),)
	...
	@g++ main.cpp -g -I. -o app -lGL -lglut
	@rm -rf $(CONFIG_FOLDER)
...
ifneq ($(DEP),)
	...
	@g++ -g -I. test.cpp -o test -DSKIPTIME=$(SKIPTIME) -lGL -lglut
...
force_test:
	...
	@mkdir -p $(CONFIG_FOLDER)
	@echo $(call build_config,test) > $(CONFIG_FILE)
	@g++ -g -I. test.cpp -o test -lGL -lglut
	clear && echo "Running all tests:" && ./test --output=color
